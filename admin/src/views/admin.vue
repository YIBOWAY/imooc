          ...
          <ul class="nav ace-nav">
            ...
            <li class="light-blue dropdown-modal">
              <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                <img class="nav-user-photo" src="../../public/ace/../../public/ace/assets/images/avatars/user.jpg" alt="Jason's Photo" /><!--两个.代表相对路径的上一级-->
        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <router-view></router-view><!--切换成子组件-->
                <!-- PAGE CONTENT ENDS -->
              </div><!-- /.col -->
            </div><!-- /.row -->
          </div><!-- /.page-content -->
        ...
        <div class="footer-inner">
          <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">syb</span>
							在线视频课程 &copy; 2020-
						</span>
            ...
            * */
            activeSidebar:function (id) {
              //兄弟菜单去掉active样式，自身增加active样式
                $("#"+id).siblings().removeClass("active");//silbings方法，获取所有兄弟结点
